            ...
            <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-100 flex items-center justify-center p-4">
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                        <div className="h-32 bg-gradient-to-r from-orange-500 to-orange-600 flex flex-col items-center justify-center text-white">
                        ...
                        <div className="p-8">
                            <form onSubmit={submit} className="space-y-6">
                                <div>
                                    ...
                                    />
                                    {errors.company_email && <div className="text-red-600 text-sm mt-1">{errors.company_email}</div>}
                                </div>
                    ...
                    <div className="mt-6 text-center text-gray-500 text-sm">
                        <p>لوحة تحكم المجهزين - خاص بشركات التجهيز والتوريد</p>
                    </div>
                </div>
            </div>
        </>
