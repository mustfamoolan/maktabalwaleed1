...
export default function AdminLayout({ children, title = 'لوحة المقر الرئيسي' }) {
    ...
    const navigation = [
        ...
        {
            name: 'فئات الموردين',
            href: '/admin/supplier-categories',
            icon: 'M19 11H5m14-4H9m6 8H9m8 4H9m-6-8h.01M3 16h.01M3 20h.01',
            description: 'إدارة أنواع وفئات الموردين'
        },
        {
            name: 'الموردين',
        ...
        },
        {
            ...
            description: 'نظام نقطة البيع POS'
        },
        {
            name: 'الأهداف والحوافز',
            href: '/admin/targets',
            icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
            description: 'نظام الأهداف والحوافز'
        },
        {
            name: 'النظام المالي',
            href: '/admin/financial',
            icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1',
            description: 'إدارة الأرباح ورأس المال'
        },
        {
            name: 'التقارير',
            href: '/admin/reports',
                        ...
                        <div className="p-3 sm:p-4 border-b border-gray-100 flex-shrink-0">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse">
                                    ...
                                    <div>
                                        <h2 className="text-sm sm:text-sm font-semibold text-gray-900">لوحة المقر الرئيسي</h2>
                            ...
                            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-2.5 sm:p-3 border border-blue-100">
                                <div className="flex items-center space-x-2 space-x-reverse">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-xs font-medium text-blue-900 truncate">المقر الرئيسي</p>
                                        <p className="text-xs text-blue-600 truncate">جميع الصلاحيات نشطة</p>
                                    </div>
                                </div>
                            </div>
                        </div>
