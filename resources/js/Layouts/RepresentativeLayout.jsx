...
export default function RepresentativeLayout({ children, title = 'لوحة تحكم المندوب' }) {
    ...
    const user = props.representative_user || null;
                        ...
                        <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4 space-x-reverse">
                            ...
                            {isMobile && (
                                <button
                                    ...
                                    className="p-1.5 sm:p-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-20"
                                >
                            ...
                            <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse">
                                ...
                                <div className="hidden xs:block sm:block">
                                    <h1 className="text-xs sm:text-sm font-semibold text-gray-900">
                                        DubaiExchange - {user?.name || 'مندوب المبيعات'}
                                    </h1>
                            ...
                            <div className="flex items-center space-x-1 sm:space-x-2 space-x-reverse">
                                <div className="hidden lg:block text-right">
                                    <p className="text-xs font-semibold text-gray-900">
                                        {user?.name || 'مندوب المبيعات'}
                                    </p>
                                    <p className="text-xs text-gray-500">
                                        {user?.type === 'representative' ? 'مندوب مبيعات' : 'موظف'}
                                    </p>
                                </div>
                            ...
                            <button
                                onClick={() => {
                                    if (confirm('هل تريد تسجيل الخروج؟')) {
                                        router.post('/representatives/logout');
                                    }
                                }}
                ...
                style={{ height: isMobile ? '100vh' : 'calc(100vh - 56px)' }}>
                    <div className="flex flex-col h-full bg-white">
                        ...
                        <div className="p-3 sm:p-4 border-b border-gray-100 flex-shrink-0">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse">
                                    ...
                                    <div>
                                        <h2 className="text-sm sm:text-sm font-semibold text-gray-900">لوحة المندوب</h2>
                        ...
                        <div className="p-3 sm:p-4 border-t border-gray-100 flex-shrink-0 bg-white">
                            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-2.5 sm:p-3 border border-green-100">
                                <div className="flex items-center space-x-2 space-x-reverse">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-xs font-medium text-green-900 truncate">مندوب نشط</p>
                                        <p className="text-xs text-green-600 truncate">جميع الصلاحيات متاحة</p>
                                    </div>
                                </div>
                            </div>
                        </div>
