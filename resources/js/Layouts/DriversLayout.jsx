...
export default function DriversLayout({ children, title = 'لوحة السائقين' }) {
    ...
    const navigation = [
        ...
        },
        {
            ...
            description: 'إدارة الرحلات والمشاوير'
        },
        {
            name: 'التوصيلات',
            href: '/drivers/deliveries',
            icon: 'M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4',
            description: 'تتبع التوصيلات'
        },
        {
            name: 'المركبة',
            href: '/drivers/vehicle',
            icon: 'M9 17a2 2 0 11-4 0 2 2 0 014 0zM21 17a2 2 0 11-4 0 2 2 0 014 0z M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6',
            description: 'معلومات المركبة والصيانة'
        },
        {
            name: 'الأرباح',
            href: '/drivers/earnings',
            icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z',
            description: 'تتبع الأرباح والمكافآت'
        },
        {
            name: 'الملف الشخصي',
                            ...
                            <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse">
                                ...
                                <div className="hidden xs:block sm:block">
                                    <h1 className="text-xs sm:text-sm font-semibold text-gray-900">
                                        DubaiExchange - {user?.name || 'السائقين'}
                                    </h1>
                        ...
                        <div className="hidden md:flex flex-1 max-w-md mx-8">
                            <div className="relative w-full">
                                <input
                                    type="text"
                                    placeholder="البحث..."
                                    className="w-full pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:bg-white focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:ring-opacity-20 focus:outline-none transition-all duration-200"
                                />
                            ...
                            <div className="flex items-center space-x-1 sm:space-x-2 space-x-reverse">
                                <div className="hidden lg:block text-right">
                                    ...
                                    <p className="text-xs text-gray-500">
                                        {user?.type === 'driver' ? 'سائق معتمد' : 'سائق'}
                                    </p>
                                </div>
                                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full flex items-center justify-center text-white text-xs sm:text-sm font-semibold">
                        ...
                        <div className="p-3 sm:p-4 border-b border-gray-100 flex-shrink-0">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse">
                                    ...
                                    <div>
                                        <h2 className="text-sm sm:text-sm font-semibold text-gray-900">لوحة السائقين</h2>
                                        <p className="text-xs text-gray-500">إدارة النقل</p>
                                    </div>
                                </div>
                                {isMobile && (
                                    <button
                            ...
                            <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-2.5 sm:p-3 border border-purple-100">
                                <div className="flex items-center space-x-2 space-x-reverse">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-xs font-medium text-purple-900 truncate">سائق نشط</p>
                                        <p className="text-xs text-purple-600 truncate">جاهز للتوصيل</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="mb-4 md:mb-6">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3 space-x-reverse">
                                        <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl flex items-center justify-center shadow-lg">
